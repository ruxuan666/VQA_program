...
class VqaDataset(data.Dataset):
    ...
    def __init__(self, input_dir, input_vqa, max_qst_length=30, max_num_ans=10, transform=None):
        ...
        self.vqa = np.load(input_dir+'/'+input_vqa,allow_pickle=True) #整合后的数据集
        self.qst_vocab = text_helper.VocabDict(input_dir+'/vocab_questions.txt') #建立类
